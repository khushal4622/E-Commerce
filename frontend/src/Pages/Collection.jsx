...
const Collection = () => {
  ...
  // Placeholder for the toggleFilter function
      ...
      <div className="flex flex-col sm:flex-row gap-8 mb-16">
        ...
        <div className="min-w-72 bg-primary p-4 pt-8 pl-6 lg:pl-12 rounded-r-xl">
          ...
          <div className="pl-5 py-3 mt-4 bg-white rounded-xl">
            ...
            <div className="flex flex-col gap-2 text-sm font-light">
              {["Men", "Women", "Kids"].map((cat, index) => (
                <label key={`category-${index}`} className="flex gap-2 medium-14 text-gray-30">
                  <input
          ...
          <div className="pl-5 py-3 mt-6 bg-white rounded-xl">
            ...
            <div className="flex flex-col gap-2 text-sm font-light">
              {["Topwear", "Bottomwear", "Kids"].map((subCat, index) => (
                <label key={`subcategory-${index}`} className="flex gap-2 medium-14 text-gray-30">
                  <input
        ...
        <div className="bg-primary p-4 rounded-l-xl">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-x-6">
