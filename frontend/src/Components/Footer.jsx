...
const Footer = () => {
    return (
        <footer>
            ...
            <div className='max-padd-container flex items-start justify-between flex-wrap gap-12 mt-12'>
                ...
                <div className='flex flex-col max-w-sm gap-y-5'>
                    <div className='bold-32'>
                        E<span className='text-secondary'>-Shopy</span>
                    </div>
            ...
            {/* copyrights */}
            <p className='max-padd-container bg-primary medium-14 py-2 px-8 rounded flexBetween mt-6'><span>2025 E-Shopy</span><span>All rights reserved</span></p>
        </footer>
    )
}
