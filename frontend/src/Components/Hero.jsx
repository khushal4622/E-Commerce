    ...
    <section className='max-padd-container bg-hero bg-cover bg-center bg-no-repeat h-[667px] w-full mb-10 relative'>
      <div className='bg-white p-3 rounded-2xl max-w-[233px] relative top-8 xl:top-12'>
        <div className='relative'>
          <img src={heroImg} alt="hero image" height={211} width={211} className='rounded-3xl mb-3' />
        ...
        <p className='text-[13px]'><b className='uppercase'>Unblock</b> your best look, one click at a time, Your style upgrade starts here, shop today!</p>
      </div>
